...
SMTP_SUBJECT="[DEV] - [DEPLOYMENT STARTS] : "${JOB_NAME}_${BUILD_NUMBER}
SMTP_BODY="Automated Deployment for "${JOB_NAME}" has been initiated by code change in the origin/develop branch, please stand by, an email will be sent after deployment has been completed."
